  ...
  return (
    <div className="pt-16 pb-16 bg-gray-950">
        <div className="w-[80%] mx-auto items-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
                <div className="text-white font-bold text-3xl mb-4">Gimy &apos;-&apos; Shop</div>
                <p className="mt-5 font-semibold text-gray-300 text-sm ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eaque molestias laboriosam aliquid maxime alias odit iste rerum modi beatae iure impedit praesentium ex repellat incidunt accusamus expedita amet, explicabo reprehenderit?</p>
                <div className=" flex items-center text-white space-x-4 mt-6">
                    ...
                    <div className="w-8 h-8 bg-pink-800 flex items-center justify-center flex-col rounded-full">
                        <FaYoutube size={16} />
                    </div>
                    <div className="w-8 h-8 bg-green-500 flex items-center justify-center flex-col rounded-full">
                        <FaWhatsapp size={16} />
                    </div>
                    <div className="w-8 h-8 bg-blue-700 flex items-center justify-center flex-col rounded-full">
                        <FaTwitter size={16} />
            ...
            <div className="space-y-5">
                ...
                <p className="text-gray-300 hover:text-gray-400 font-medium cursor-pointer text-sm">Service</p>
            ...
            <div className="space-y-5">
                ...
                <p className="text-gray-300 hover:text-gray-400 font-medium cursor-pointer text-sm">Contact Us</p>
            </div>
            <div>
                <h1 className="text-lg text-white font-bold"> Get In Touch</h1>
                <div className="mt-6">
                    <h1 className="text-sm text-white font-bold">Our Mobile Number</h1>
                    <h1 className="text-base text-white font-bold mt-1">01122503776</h1>
                </div>
                <div className="mt-6">
                    <h1 className="text-sm text-white font-bold">Our Address</h1>
                    <h1 className="text-base text-white font-bold mt-1">Maadi Cairo Egypt</h1>
                </div>
            </div>
            </div>
